...
import { StaffManagementPanel } from '@/components/coach/StaffManagementPanel';
...
export default function TeamSettings() {
  const { getMyTeam, updateKit, requestFacilityUpgrade, updateStaff, updatePhilosophy } = useGame();
      ...
      <Tabs defaultValue="staff">
        ...
        <TabsContent value="staff" className="mt-6">
          <StaffManagementPanel
            ...
            onUpdatePhilosophy={updatePhilosophy}
          />
        </TabsContent>
