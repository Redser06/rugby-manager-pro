...
function SocialButtons({ isGoogleLoading, isAppleLoading, onGoogle, onApple }: {
  ...
  return (
    <div className="space-y-2">
      ...
      >
        {isGoogleLoading ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <GoogleIcon />}
      ...
      <Button
        ...
        disabled={isGoogleLoading || isAppleLoading}
      >
        {isAppleLoading ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <AppleIcon />}
        Continue with Apple
      </Button>
    </div>
  );
